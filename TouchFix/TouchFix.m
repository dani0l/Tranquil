...
@interface Tranquil__GSEvent : NSObject {
@public
    unsigned int flags;
    unsigned int type;
...
@implementation Tranquil__GSEvent
...
- (id)_initWithEvent:(Tranquil__GSEvent *)fp8 touches:(id)fp12;

@end


@implementation UITouch (Tranquil__TouchFix)
...
@implementation UIEvent (Tranquil__TouchFix)

- (instancetype)initWithTouch:(UITouch *)touch {
    CGPoint location = [touch locationInView:touch.window];
    
    Tranquil__GSEvent *gsEventProxy = [[Tranquil__GSEvent alloc] init];
